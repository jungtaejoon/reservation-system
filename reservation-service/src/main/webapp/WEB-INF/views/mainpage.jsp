...
<body>
		...
		<div class="event">
					...
					<div class="container_visual">
						...
						<div>
							<div class="container_visual">
								...
								<ul class="visual_img">
									<li class="item"
										style="background-image: url(http://naverbooking.phinf.naver.net/20170209_66/1486628146913la6nC_JPEG/image.jpg); width: 349px;">
									...
									<li class="item"
										style="background-image: url(http://naverbooking.phinf.naver.net/20170119_48/1484802596907hmVDm_JPEG/image.jpg); width: 349px;">
										<a href="#"> <span class="img_btm_border"></span> <span
											class="img_right_border"></span> <span class="img_bg_gra"></span>
											<div class="event_txt">
			...
			<div class="section_event_tab">
				<ul class="event_tab_lst tab_lst_min">
					<li class="item" data-category="1"><a class="anchor active">
							<span>전체</span>
					</a></li>
	...
	<script id="main-category-template" type="text/x-handlebars-template">
	...
	<script src="/resources/mainpage.js"></script>
</body>
