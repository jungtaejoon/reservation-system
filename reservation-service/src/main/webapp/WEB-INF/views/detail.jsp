                    ...
                    <div class="group_visual">
                        <div>
                            <div class="container_visual" style="width: 414px;">
                                <ul class="visual_img" style="left: -414px;">
                ...
                <div class="section_event">
                    <div class="event_info_box">
                        ...
                        <div class="event_info">
                            <div class="in_dsc" id ="event_info">[네이버예약 특별할인]<br>R석 50%, S석 60% 할인</div>
                        </div>
                    </div>
                </div>
                                ...
                                <script id="comment_template" type="text/x-handlebars-template">
                                    ...
                                    <li class="list_item">
                                        <div>
                                            ...
                                            <div class="info_area">
                                                <div class="review_info"> <span class="grade">{{score}}</span> <span class="name">{{userName}}</span> <span class="date">{{date}} 방문</span> </div>
                                            </div>
                                        </div>
                                    </li>
                                    {{/item}}
                        ...
                        <div class="box_store_info no_topline">
                            ...
                            <div class="store_info">
                                <div class="store_addr_wrap">
                                    ...
                                    <p class="store_addr store_addr_bold" id="addr">서울특별시 종로구 종로33길 15 </p>
                                    <p class="store_addr">
                                        <span class="addr_old">지번</span>
                                        <span class="addr_old_detail" id ="addr_old">서울특별시 종로구 연지동 270 </span>
                                    </p>
                                    <p class="store_addr addr_detail" >두산아트센터 연강홀</p>
                                </div>
                                <div class="lst_store_info_wrap">
                                    <ul class="lst_store_info">
                                        <li class="item"> <span class="item_lt"> <i class="fn fn-call2"></i> <span class="sr_only">전화번호</span> </span> <span class="item_rt"> <a href="tel:02-548-0597" class="store_tel" id = "store_tel">02-548-0597</a></span> </li>
                                    </ul>
                                </div>
                            </div>
...
<script type="text/javascript" src="https://openapi.map.naver.com/openapi/v3/maps.js?clientId=vpxjnGcgMhasKc_aH1HK&submodules=geocoder"></script>
