        ...
        <div class="ct main">
            <div>
                <div class="section_visual">
                    ...
                    <div class="pagination">
                        ...
                        <div class="figure_pagination">
                            ...
                            <span class="num off">/ <span>${product_info.count_images}</span></span>
                        </div>
                    </div>
                ...
                <div class="section_review_list">
                    <div class="review_box">
                        ...
                        <div class="short_review_area">
                            <div class="grade_area">
                                ...
                                <span class="graph_mask"> <em class="graph_value" style="width: ${product_info.comment_score.percent}%;"></em> </span>
                                <strong class="text_value"> <span>${product_info.comment_score.score}</span> <em class="total">5.0</em> </strong>
                                <span class="join_count"><em class="green">${product_info.comment_score.count}건</em> 등록</span>
                            </div>
                    ...
                    <a class="btn_review_more" href="/comments/${product_info.product.id}"> <span>예매자 한줄평 더보기</span> <i class="fn fn-forward1"></i> </a>
                </div>
