...
<body>
		...
		<div class="ct main">
			<div>
				<div class="section_visual">
					<header>
						<h1 class="logo">
							<a href="http://m.naver.com" class="lnk_logo" title="네이버"> <span
								class="spr_bi ico_n_logo">네이버</span>
							</a> <a href="/" class="lnk_logo" title="예약"> <span
								class="spr_bi ico_bk_logo">예약</span>
							</a>
							...
							<div class="container_visual" style="width: 414px;">
								<ul class="visual_img">
									<!-- <li class="item" style="width: 414px;"><img alt=""
										class="img_thumb"
										src="../resources/myimage/20170715/a6cd25f5-c403-41e1-a829-df0b375e1aab">
				...
				<div class="section_store_details">
					...
					<div class="store_details close3">
						<p class="dsc">웰메이드 창작 뮤지컬의 대표 브랜드 '김수로 프로젝트' 최신작! 연극, 뮤지컬, 무용
							등 매년 작품성 있는 창작 공연을 선보이며, 대한민국 대표 웰메이드 창작 브랜드로 자리매김한 '김수로 프로젝트'의
							최신작 입니다.</p>
					</div>
				...
				<div class="section_info_tab">
					...
					<ul class="info_tab_lst">
						<li class="item _detail"><a href="#" class="anchor active">
								<span>상세정보</span>
						</a></li>
	...
	<div id="photoviewer" class="my_popup_layer">
		<button id="btn_x" style="width: 43px; height: 43px;">x</button>
		<button id="btn_popup_prev" style="width: 43px; height: 43px;">이전</button>
		<button id="btn_popup_next" style="width: 43px; height: 43px;">다음</button>
		<div class="sec_img" style="width: 414px;">
			<ul class="img_list" style="position: relative; white-space: nowrap;">
				<li class="img_item" style="width: 414px;"><img
					class="review_img" style="width: 414px;" src=""></li>
			</ul>
		</div>
	</div>

	<script id="detail-product-image-template"
	...
	<script id="detail-comment-template" type="text/x-handlebars-template">
        <li class="list_item">
									<div>
										<div class="review_area">
											<div class="thumb_area">
												<a href="#" class="thumb" title="이미지 크게 보기" id="{{commentId}}"> <img
													width="90" height="90" class="img_vertical_top"
													src=""
													alt="리뷰이미지">
	...
	<script id="review-images-template" type="text/x-handlebars-template">
        <li class="img_item" style="width: 414px; overflow: hidden; position: relative; display: inline-block; white-space: normal; margin-left:-4px;"><img class="review_img" style="width: 414px;"
			src="{{saveFileName}}"></li>
    </script>

	<script type="text/javascript" src="//openapi.map.naver.com/openapi/v3/maps.js?clientId=xG6IjQpP8c8ePRi3w__i&submodules=geocoder"></script>
