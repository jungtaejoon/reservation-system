...
<body>
        ...
        <div class="ct">
            <div class="ct_wrap">
                <div class="top_title">
                    ...
                    <h2><span class="title">${productDetail.name }</span></h2>
                </div>
                    ...
                    <div class="container_visual" style="width: 414px;">
                        <ul class="visual_img" id="slider">
                            ...
                            <li class="item" style="width: 414px;"> <img alt="" class="img_thumb" src="https://ssl.phinf.net/naverbooking/20170217_264/1487312141947lTddT_JPEG/%B3%D7%C0%CC%B9%F6.jpg?type=ff1242_816"> <span class="img_bg"></span>
                                ...
                                <h2 class="preview_txt_tit">클림트 인사이드</h2> <em class="preview_txt_dsc">₩12,000 ~ </em><em class="preview_txt_dsc">2017.2.17.(금)~2017.4.18.(화), 잔여티켓 2769매</em> 
                            </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="section_booking_ticket">
                    <div class="ticket_body">
                    	...
                    	<c-rt:forEach var="price" items="${prices}" varStatus="status">
	                        <div class="qty">
	                            ...
	                            <div class="qty_info_icon"> <strong class="product_amount"> <span>${price.priceType }</span> </strong> <strong class="product_price"> <span class="price"><fmt:formatNumber value="${price.price * (100 - price.discountRate) / 100 }" pattern=""/></span> <span class="price_type">원</span> </strong> <em class="product_dsc"><fmt:formatNumber value="${price.price }" pattern=""/> (<fmt:formatNumber value="${price.discountRate }" pattern=""/>% 할인가)</em> </div>
	                        </div>
                        </c-rt:forEach>
	...
	<script type="text/javascript" src="/node_modules/@egjs/component/dist/component.min.js"></script>
	<script type="text/javascript" src="/resources/js/slider.js"></script>
	<script type="text/javascript" src="/resources/js/confirmation.js"></script>
	<script type="text/javascript" src="/resources/js/reserveCounter.js"></script>
	<script type="text/javascript">
		$(function() {
			var rc = new ReserveCounter('.section_booking_ticket');
			rc.init($('.section_booking_form'));
			Slider.init(true);
