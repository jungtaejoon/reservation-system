...
<body>
        ...
        <div class="ct">
            <div class="ct_wrap">
                <div class="top_title">
                    ...
                    <h2><span class="title" id ="top_name">클림트 인사이드</span></h2>
                </div>
                ...
                <div class="section_booking_ticket">
                    <div class="ticket_body">
                        <script id="price_template" type="text/x-handlebars-template">
                            {{#item}}
                            <div class="qty">
                                <div class="count_control">
                                    <!-- [D] 수량이 최소 값이 일때 ico_minus3, count_control_input에 disabled 각각 추가, 수량이 최대 값일 때는 ico_plus3에 disabled 추가 -->
                                    <div class="clearfix">
                                        <a class="btn_plus_minus spr_book2 ico_minus3 disabled" title="빼기"> </a> <input type="tel" class="count_control_input disabled" value="{{count}}" readonly title="수량">
                                        <a class="btn_plus_minus spr_book2 ico_plus3" title="더하기">
                                        </a>
                                    </div>
                                    <!-- [D] 금액이 0 이상이면 individual_price에 on_color 추가 -->
                                    <div class="individual_price"><span class="total_price">{{total_price}}</span><span class="price_type">원</span></div>
                                </div>
                                <div class="qty_info_icon"> <strong class="product_amount"> <span>{{type_value}}</span> </strong> <strong class="product_price"> <span class="price">{{price}}</span> <span class="price_type">원</span> </strong> <em class="product_dsc">{{discount_price}}원 ({{discount}}% 할인가)</em> </div>
                            ...
                            <form class="form_horizontal">
                                ...
                                <div class="inline_form last"> <label class="label" for="message">예매내용</label>
                                    <div class="inline_control">
                                        <p class="inline_txt selected" id="reservation_final">총 0매</p>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <script src="/resources/js/productReserve.js"></script>
