...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _buildDetail = __webpack_require__(1);
	
	var _naverMap = __webpack_require__(4);
	
	var _slider = __webpack_require__(5);
	
	var _sliderPanel = __webpack_require__(7);
	
	var _flicker = __webpack_require__(8);
	
	var _thumbnailSlider = __webpack_require__(9);
	...
	$(function () {
	    ...
	    var slider = new _slider.Slider('#detail_slider', {
	        max: childrenLength,
	        prevButton: '.btn_prev',
	        nextButton: '.btn_nxt',
	    ...
	    new _sliderPanel.SliderPanel('span.num:not(.off)', slider);
	    new _flicker.Flicker(slider);
	
	    var thumbnailSlider = new _thumbnailSlider.ThumbnailSlider();
	    new _flicker.Flicker(thumbnailSlider);
	
	    _buildDetail.BuildDetail.init();
	    _naverMap.NaverMap.init();
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SliderPanel = function (_Component) {
	    _inherits(SliderPanel, _Component);
	
	    function SliderPanel(panel, slider) {
	        _classCallCheck(this, SliderPanel);
	
	        var _this = _possibleConstructorReturn(this, (SliderPanel.__proto__ || Object.getPrototypeOf(SliderPanel)).call(this));
	
	        _this.panel = panel;
	        _this.slider = slider;
	
	        if (_this.slider.maxIndex == 0) {
	            $(_this.slider.option.nextButton).find('i').addClass('off');
	        } else {
	            _this.bindEvents();
	        }
	        return _this;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.ThumbnailSlider = undefined;
	...
	var ThumbnailSlider = function (_Component) {
	    _inherits(ThumbnailSlider, _Component);
	
	    function ThumbnailSlider() {
	        _classCallCheck(this, ThumbnailSlider);
	
	        var _this = _possibleConstructorReturn(this, (ThumbnailSlider.__proto__ || Object.getPrototypeOf(ThumbnailSlider)).call(this));
	
	        _this.THUMBNAIL = '.thumb';
	        _this.PHOTO_VIEWER = '#photoviewer';
	        _this.LAYER = '#layer';
	        _this.SUB_LAYER = '.sub_layer';
	        _this.IMG_WRAPPER = '.wrapper img';
	        _this.BUTTON_WRAPPER = '.btn_wrapper';
	        _this.CLOSE_BUTTON = '.com_img_btn.close';
	        _this.PREV_BUTTON = '.com_img_btn.prev';
	        _this.NEXT_BUTTON = '.com_img_btn.nxt';
	        _this.x = 0;
	        _this.point = 0;
	        _this.imgCount = 0;
	        _this.template = __webpack_require__(11);
	        _this.rootDOM = _this.PHOTO_VIEWER;
	        _this.toBeMovedDOM = _this.IMG_WRAPPER;
	        _this.bindEvents();
	        return _this;
	    }
	    ...
	    _createClass(ThumbnailSlider, [{
	        ...
	        value: function bindEvents() {
	            ...
	            $(this.LAYER).on('click', this.CLOSE_BUTTON, this.hideViewer.bind(this)).on('click', this.PREV_BUTTON, this.clickPrev.bind(this)).on('click', this.NEXT_BUTTON, this.clickNext.bind(this));
	            $(this.PHOTO_VIEWER).on('click', this.toggleBtnVisible.bind(this));
	            $(window).resize(this.resizeImg.bind(this));
	        }
	    }, {
	        key: "hideViewer",
	        value: function hideViewer(e) {
	            e.stopPropagation();
	        ...
	        key: "toggleBtnVisible",
	        value: function toggleBtnVisible() {
	        ...
	        key: "popupViewer",
	        value: function popupViewer(e) {
	            e.preventDefault();
	            this.point = 0;
	            var url = '/comments/' + $(e.target).data('comment-id') + '/images';
	            _cachedAjax.CachedAjax.get(url).then(this.imgLoad.bind(this));
	            $(this.PHOTO_VIEWER).removeClass('invisible');
	        }
	    }, {
	        key: "imgLoad",
	        value: function imgLoad(res) {
	...
	exports.ThumbnailSlider = ThumbnailSlider;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({ "1": function _(container, depth0, helpers, partials, data) {
	    ...
	    return "<div class=\"sub_layer\" style=\"transform: translateX(" + alias4((helper = (helper = helpers.tranx || (depth0 != null ? depth0.tranx : depth0)) != null ? helper : alias2, (typeof helper === "undefined" ? "undefined" : _typeof(helper)) === alias3 ? helper.call(alias1, { "name": "tranx", "hash": {}, "data": data }) : helper)) + "%)\">\n    <div class=\"wrapper\">\n        <img src=\"/files/" + alias4((helper = (helper = helpers.fileId || (depth0 != null ? depth0.fileId : depth0)) != null ? helper : alias2, (typeof helper === "undefined" ? "undefined" : _typeof(helper)) === alias3 ? helper.call(alias1, { "name": "fileId", "hash": {}, "data": data }) : helper)) + "\">\n    </div>\n    <div class=\"btn_wrapper\">\n        <button class=\"com_img_btn close\">X</button>\n        <button class=\"com_img_btn prev\"><</button><button class=\"com_img_btn nxt\">></button>\n    </div>\n</div>\n";
