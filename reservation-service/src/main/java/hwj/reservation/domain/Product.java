...
public class Product {
	...
	public Product(){}
	public Product(int id, int categoryId, String name, String description, Date salesStart, Date salesEnd,
	...
	public Product(int categoryId, String name, String description, Date salesStart, Date salesEnd, int salesFlag,
